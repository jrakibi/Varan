	...
	_tg_timerangeslider.slider({
		...
		slide: function (e, ui) {
			...
			jQuery('.tg-timeslider2').html(hours2 + ':' + minutes2);
                	...
                	jQuery( "#timeMin" ).val(hours1 + ':' + minutes1);
                        jQuery( "#timeMax" ).val( hours2 + ':' + minutes2 );
	...
	function ageRangeslider(){
		jQuery("#tg-consultationfeerangeslider").slider({
			...
			slide: function( event, ui ) {
				...
				jQuery( "#fraisMin" ).val( ui.values[ 0 ]);
				jQuery( "#fraisMax" ).val( ui.values[ 1 ] );
			}
		});
		...
		jQuery( "#fraisMin" ).val(jQuery("#tg-consultationfeerangeslider").slider( "values", 0 ));
		jQuery( "#fraisMax" ).val(jQuery("#tg-consultationfeerangeslider").slider( "values", 1 ));
	}
	ageRangeslider();
	/* -------------------------------------
			RADIUS RANGE SLIDER
	...
	function radiusRangeslider(){
		jQuery("#tg-radiusrangeslider").slider({
			...
			slide: function( event, ui ) {
				...
				jQuery( "#distanceMin" ).val( ui.values[ 0 ]);
				jQuery( "#distanceMax" ).val( ui.values[ 1 ]);
                                
                                
			}
		});
		jQuery( "#tg-radiusamount" ).val( jQuery( "#tg-radiusrangeslider" ).slider( "values", 0 ) + " - " + jQuery( "#tg-radiusrangeslider" ).slider( "values", 1 ) );
		jQuery( "#distanceMin" ).val( jQuery( "#tg-radiusrangeslider" ).slider( "values", 0 ));
		jQuery( "#distanceMax" ).val( jQuery( "#tg-radiusrangeslider" ).slider( "values", 1 ));
